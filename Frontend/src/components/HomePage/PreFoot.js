            ...
            <Grid container spacing={4} style={{
                ...
                <Grid item xs={8} >
                    <div style={{ padding: '5rem' }}>
                        ...
                        SalamtyFirst is a comprehensive industrial safety and surveillance system designed to enhance workplace safety and security. Leveraging live video streams from multiple areas within an industrial environment, it utilizes advanced computer vision and machine learning algorithms and IOT sensors  to monitor worker compliance with safety gear, detect signs of fire, gas leaks and recognize distress signals. By providing real-time alerts and notifications to both workers and supervisors, SalamtyFirst aims to minimize workplace accidents, ensure prompt responses to emergencies, and improve overall safety conditions in industrial settings.
                        </p>
